...
var theme_default = hopeTheme({
  ...
  editLink: false,
  copyright:
    '<a target="_blank" class="ltpp-link animate" href="mailto:root@ltpp.vip">\xA9 2021 - present eastspire \u7248\u6743\u6240\u6709</a>',
  // 多语言配置
  metaLocales: {
...
!is_dev &&
  console.log(`${is_ltpp_pages ? 'LTPP-GIT' : 'GITHUB'}\u6D41\u6C34\u7EBF`);
